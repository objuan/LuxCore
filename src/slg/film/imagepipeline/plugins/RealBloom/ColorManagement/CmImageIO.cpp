...
void CmImageIO::init()
{
    ...
    else
    {
        ...
        for (const auto& space : userSpaces)
        {
            ...
            if (boost::algorithm::starts_with(spaceLower,"linear") && strContains(spaceLower, "709") && !strContains(spaceLower, "i-e"))
            {
    ...
    else
    {
        ...
        {
            std::string spaceLower = strLowercase(space);
            if (boost::algorithm::starts_with(spaceLower,"srgb") && !strContains(spaceLower, "i-e"))
            {
