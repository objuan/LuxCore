...
SAMPLERSHAREDDATA_STATICTABLE_REGISTER(MetropolisFastSampler::GetObjectTag(), MetropolisFastSamplerSharedData);
...
SAMPLER_OBJECTSTATICREGISTRY_REGISTER(SamplerRegistry, MetropolisFastSampler);
